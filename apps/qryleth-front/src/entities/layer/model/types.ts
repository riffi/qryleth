...
export enum GfxLayerType {
  ...
  /** Слой воды */
  Water = 'water',
  /** Слой окружения (ветер, небо/туман/экспозиция, наборы облаков) */
  Environment = 'environment',
  /**
   * УСТАРЕВШЕЕ: исторический тип слоя облаков.
   * Сохранён временно для совместимости компиляции до завершения миграции.
   * Не использовать в новой архитектуре; вместо него применять Environment.
   */
  Clouds = 'clouds',
}
