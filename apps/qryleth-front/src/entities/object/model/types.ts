...
export interface GfxObject {
  ...
  */
   ...
   * Хранит сериализованные входные параметры генератора и UUID материала травы.
   * Эти данные используются для детерминированной реконструкции пучка травы при отображении/использовании.
   */
  grassData?: {
    /** Сериализованные параметры генерации травы (совместимы с GrassGeneratorParams). */
    params: any;
    /** UUID материала травы. */
