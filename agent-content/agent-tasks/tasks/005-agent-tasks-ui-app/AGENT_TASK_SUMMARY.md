...
- На странице редактирования задачи в списке фаз добавить возможность просмотра содержимого phase_*_summary.md файлов. Инлайн кнопка "Посмотреть отчет", при нажатии на которую с сервера подгружается отчет по фазе и отображается во всплывающем окне.
- При отображении содержимого в режиме просмотра добавить возможность корректировки во всплывающем окне текста фазы из AGENT_TASK_SUMMARY. Для этого добавить прямо в режиме отображения markdown инлайн кнопки редактирования у каждого из заголовков фаз.
