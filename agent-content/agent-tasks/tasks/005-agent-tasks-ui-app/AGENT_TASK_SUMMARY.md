...
- На странице редактирования задачи в списке фаз добавить возможность просмотра содержимого phase_*_summary.md файлов
- При отображении содержимого в режиме просмотра добавить возможность корректировки во всплывающем окне текста фазы из AGENT_TASK_SUMMARY
