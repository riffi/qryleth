...
При выполнении каждой фазы следует сверяться с требованиями [AGENT_TASKS.md](../../spec/AGENT_TASKS.md).
...
Подробности см. в [phases/phase_6_summary.md](phases/phase_6_summary.md).

## Критерии готовности
- [x] Все вхождения "placement" заменены на "objectInstance"
- [x] Код компилируется без ошибок
- [x] Все типы корректно обновлены
