...
Примечание: неймспейс `features/editor/object/*` является основным и замещает удалённый `features/object-editor/*` (см. миграцию 027). Публичный API сфокусирован и не содержит избыточных реэкспортов.
