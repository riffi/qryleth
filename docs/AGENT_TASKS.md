...
7) Фазу исследования нужно выполнить сразу же.
8) создание агентской задачи считается законченной, когда есть AGENT_TASK_SUMMARY.md, в нем перечислены фазы и фаза исследования завершена.
